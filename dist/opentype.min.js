...
"use strict";function toArrayBuffer(e){for(var a=new ArrayBuffer(e.length),r=new Uint8Array(a),s=0;s<e.length;s+=1)r[s]=e[s];return a}function loadFromFile(e,a){var r=require("fs");r.readFile(e,function(e,r){return e?a(e.message):void a(null,toArrayBuffer(r))})}function loadFromUrl(e,a){var r=new XMLHttpRequest;r.open("get",e,!0),r.responseType="arraybuffer",r.onload=function(){return 200!==r.status?a("Font could not be loaded: "+r.statusText):a(null,r.response)},r.send()}function parseBuffer(e,a){var r,s,t,n,o,p,l,i=new _font.Font,u=new DataView(e,0),f=parse.getFixed(u,0);if(1===f)i.outlinesFormat="truetype";else{if(f=parse.getTag(u,0),"OTTO"!==f)throw new Error("Unsupported OpenType version "+f);i.outlinesFormat="cff"}for(var c=parse.getUShort(u,4),h=12,d=0;c>d;d+=1){var m=parse.getTag(u,h),b=parse.getULong(u,h+8);switch(m){case"cmap":i.tables.cmap=cmap.parse(u,b),i.encoding=new encoding.CmapEncoding(i.tables.cmap),i.encoding||(i.supported=!1);break;case"head":i.tables.head=head.parse(u,b),i.unitsPerEm=i.tables.head.unitsPerEm,r=i.tables.head.indexToLocFormat;break;case"hhea":i.tables.hhea=hhea.parse(u,b),i.ascender=i.tables.hhea.ascender,i.descender=i.tables.hhea.descender,i.numberOfHMetrics=i.tables.hhea.numberOfHMetrics;break;case"hmtx":s=b;break;case"maxp":i.tables.maxp=maxp.parse(u,b),i.numGlyphs=i.tables.maxp.numGlyphs;break;case"name":i.tables.name=_name.parse(u,b),i.familyName=i.tables.name.fontFamily,i.styleName=i.tables.name.fontSubfamily;break;case"OS/2":i.tables.os2=os2.parse(u,b);break;case"post":i.tables.post=post.parse(u,b),i.glyphNames=new encoding.GlyphNames(i.tables.post);break;case"glyf":t=b;break;case"loca":n=b;break;case"CFF ":o=b;break;case"kern":p=b;break;case"GPOS":l=b}h+=16}if(t&&n){var g=0===r;i.locaTable=loca.parse(u,n,i.numGlyphs,g),i.glyfOffset=t,i.locaOffset=n,i.hmtxOffset=s,i.rawdata=u,i.glyphs=a?[]:glyf.parse(u,t,i.locaTable,i),i.hmtx=hmtx.parse(u,s,i.numberOfHMetrics,i.numGlyphs,i.glyphs),encoding.addGlyphNames(i)}else o?(cff.parse(u,o,i),encoding.addGlyphNames(i)):i.supported=!1;return i.supported&&(p?i.kerningPairs=kern.parse(u,p):i.kerningPairs={},l&&gpos.parse(u,l,i)),i}function load(e,a,r){var s="undefined"==typeof window,t=s?loadFromFile:loadFromUrl;r="undefined"==typeof r?a:r,a="boolean"==typeof a?a:!1,t(e,function(e,s){if(e)return r(e);var t=parseBuffer(s,a);return t.lazyParsing=a,t.supported?r(null,t):r("Font is not supported (is this a Postscript font?)")})}var encoding=require("./encoding"),_font=require("./font"),glyph=require("./glyph"),parse=require("./parse"),path=require("./path"),cmap=require("./tables/cmap"),cff=require("./tables/cff"),glyf=require("./tables/glyf"),gpos=require("./tables/gpos"),head=require("./tables/head"),hhea=require("./tables/hhea"),hmtx=require("./tables/hmtx"),kern=require("./tables/kern"),loca=require("./tables/loca"),maxp=require("./tables/maxp"),_name=require("./tables/name"),os2=require("./tables/os2"),post=require("./tables/post");exports._parse=parse,exports.Font=_font.Font,exports.Glyph=glyph.Glyph,exports.Path=path.Path,exports.parse=parseBuffer,exports.load=load;
...
"use strict";function parseHmtxTable(e,a,r,t,n){for(var l,s,i=0===n.length?[]:n,p=new parse.Parser(e,a),d=0;t>d;d+=1)r>d&&(l=p.parseUShort(),s=p.parseShort()),i[d]=i[d]||{},i[d].advanceWidth=l,i[d].leftSideBearing=s;return i}function makeHmtxTable(e){for(var a=new table.Table("hmtx",[]),r=0;r<e.length;r+=1){var t=e[r],n=t.advanceWidth||0,l=t.leftSideBearing||0;a.fields.push({name:"advanceWidth_"+r,type:"USHORT",value:n}),a.fields.push({name:"leftSideBearing_"+r,type:"SHORT",value:l})}return a}var parse=require("../parse"),table=require("../table");exports.parse=parseHmtxTable,exports.make=makeHmtxTable;
