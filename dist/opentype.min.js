...
"use strict";function parseMetaTable(e,a,t){var r=["dlng","slng"];t&&(r=r.concat(t));var s=new parse.Parser(e,a),n=s.parseULong();check.argument(1===n,"Unsupported META table version."),s.parseULong(),s.parseULong();for(var p=s.parseULong(),l=[],u=0;p>u;u++){var o=s.parseTag();if(-1!==r.indexOf(o)){var g=s.parseULong(),v=s.parseULong(),d=decode.UTF8(e,g,v);l.push({tag:o,data:d})}}return l}function makeMetaTable(e){for(var a="",t=16+12*e.length,r=new table.Table("meta",[{name:"version",type:"ULONG",value:1},{name:"flags",type:"ULONG",value:0},{name:"offset",type:"ULONG",value:t},{name:"numTags",type:"ULONG",value:e.length}]),s=0;s<e.length;++s){var n=a.length;a+=e[s].data,r.fields.push({name:"tag "+s,type:"TAG",value:e[s].tag}),r.fields.push({name:"offset "+s,type:"ULONG",value:t+n}),r.fields.push({name:"length "+s,type:"ULONG",value:e[s].data.length})}return r.fields.push({name:"stringPool",type:"CHARARRAY",value:a}),r}var types=require("../types"),decode=types.decode,check=require("../check"),parse=require("../parse"),table=require("../table");exports.parse=parseMetaTable,exports.make=makeMetaTable;
