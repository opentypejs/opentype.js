...
"use strict";function getPathDefinition(t){var i=t||{commands:[]};return{configurable:!0,get:function(){return"function"==typeof i&&(i=i()),i},set:function(t){i=t}}}function Glyph(t){this.font=t.font||null,this.index=t.index||0,this.name=t.name||null,this.unicode=t.unicode||void 0,this.unicodes=t.unicodes||void 0!==t.unicode?[t.unicode]:[],this.xMin=t.xMin||0,this.yMin=t.yMin||0,this.xMax=t.xMax||0,this.yMax=t.yMax||0,this.advanceWidth=t.advanceWidth||0,Object.defineProperty(this,"path",getPathDefinition(t.path))}var check=require("./check"),draw=require("./draw"),path=require("./path");Glyph.prototype.addUnicode=function(t){0===this.unicodes.length&&(this.unicode=t),this.unicodes.push(t)},Glyph.prototype.getPath=function(t,i,e){t=void 0!==t?t:0,i=void 0!==i?i:0,e=void 0!==e?e:72;for(var n=1/this.font.unitsPerEm*e,h=new path.Path,o=this.path.commands,a=0;a<o.length;a+=1){var r=o[a];"M"===r.type?h.moveTo(t+r.x*n,i+-r.y*n):"L"===r.type?h.lineTo(t+r.x*n,i+-r.y*n):"Q"===r.type?h.quadraticCurveTo(t+r.x1*n,i+-r.y1*n,t+r.x*n,i+-r.y*n):"C"===r.type?h.curveTo(t+r.x1*n,i+-r.y1*n,t+r.x2*n,i+-r.y2*n,t+r.x*n,i+-r.y*n):"Z"===r.type&&h.closePath()}return h},Glyph.prototype.getContours=function(){if(void 0===this.points)return[];for(var t=[],i=[],e=0;e<this.points.length;e+=1){var n=this.points[e];i.push(n),n.lastPointOfContour&&(t.push(i),i=[])}return check.argument(0===i.length,"There are still points left in the current contour."),t},Glyph.prototype.getMetrics=function(){for(var t=this.path.commands,i=[],e=[],n=0;n<t.length;n+=1){var h=t[n];"Z"!==h.type&&(i.push(h.x),e.push(h.y)),("Q"===h.type||"C"===h.type)&&(i.push(h.x1),e.push(h.y1)),"C"===h.type&&(i.push(h.x2),e.push(h.y2))}var o={xMin:Math.min.apply(null,i),yMin:Math.min.apply(null,e),xMax:Math.max.apply(null,i),yMax:Math.max.apply(null,e),leftSideBearing:0};return o.rightSideBearing=this.advanceWidth-o.leftSideBearing-(o.xMax-o.xMin),o},Glyph.prototype.draw=function(t,i,e,n){this.getPath(i,e,n).draw(t)},Glyph.prototype.drawPoints=function(t,i,e,n){function h(i,e,n,h){var o=2*Math.PI;t.beginPath();for(var a=0;a<i.length;a+=1)t.moveTo(e+i[a].x*h,n+i[a].y*h),t.arc(e+i[a].x*h,n+i[a].y*h,2,0,o,!1);t.closePath(),t.fill()}i=void 0!==i?i:0,e=void 0!==e?e:0,n=void 0!==n?n:24;for(var o=1/this.font.unitsPerEm*n,a=[],r=[],s=this.path,p=0;p<s.commands.length;p+=1){var l=s.commands[p];void 0!==l.x&&a.push({x:l.x,y:-l.y}),void 0!==l.x1&&r.push({x:l.x1,y:-l.y1}),void 0!==l.x2&&r.push({x:l.x2,y:-l.y2})}t.fillStyle="blue",h(a,i,e,o),t.fillStyle="red",h(r,i,e,o)},Glyph.prototype.drawMetrics=function(t,i,e,n){var h;i=void 0!==i?i:0,e=void 0!==e?e:0,n=void 0!==n?n:24,h=1/this.font.unitsPerEm*n,t.lineWidth=1,t.strokeStyle="black",draw.line(t,i,-1e4,i,1e4),draw.line(t,-1e4,e,1e4,e),t.strokeStyle="blue",draw.line(t,i+this.xMin*h,-1e4,i+this.xMin*h,1e4),draw.line(t,i+this.xMax*h,-1e4,i+this.xMax*h,1e4),draw.line(t,-1e4,e+-this.yMin*h,1e4,e+-this.yMin*h),draw.line(t,-1e4,e+-this.yMax*h,1e4,e+-this.yMax*h),t.strokeStyle="green",draw.line(t,i+this.advanceWidth*h,-1e4,i+this.advanceWidth*h,1e4)},exports.Glyph=Glyph;


},{"./check":1,"./draw":2,"./path":9}],6:[function(require,module,exports){
"use strict";function GlyphSet(t){this.font=t,this.length=0,this.glyphs={}}var _glyph=require("./glyph");GlyphSet.prototype={get:function(t){return"function"==typeof this.glyphs[t]&&(this.glyphs[t]=this.glyphs[t]()),this.glyphs[t]||console.log(t+" does not exist..."),this.glyphs[t]},push:function(t,n){this.glyphs[t]=n,this.length++}},GlyphSet.glyphLoader=function(t,n){return new _glyph.Glyph({index:n,font:t})},GlyphSet.ttfGlyphLoader=function(t,n,h,e,p,l){return function(){var o=new _glyph.Glyph({index:n,font:t});return o.path=function(){return h(o,e,p),l(t.glyphs,o)},o}},GlyphSet.cffGlyphLoader=function(t,n,h,e){return function(){var p=new _glyph.Glyph({index:n,font:t});return p.path=function(){return h(t,p,e)},p}},module.exports=GlyphSet;
