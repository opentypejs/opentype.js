...
"use strict";function GlyphSet(t){this.font=t,this.length=0,this.glyphs={}}var _glyph=require("./glyph");GlyphSet.prototype={get:function(t){return"function"==typeof this.glyphs[t]&&(this.glyphs[t]=this.glyphs[t]()),this.glyphs[t]},push:function(t,n){this.glyphs[t]=n,this.length++}},GlyphSet.glyphLoader=function(t,n){return new _glyph.Glyph({index:n,font:t})},GlyphSet.ttfGlyphLoader=function(t,n,e,h,r,p){return function(){var i=new _glyph.Glyph({index:n,font:t});return i.path=function(){e(i,h,r);var n=p(t,i);return n.unitsPerEm=t.unitsPerEm,n},i}},GlyphSet.cffGlyphLoader=function(t,n,e,h){return function(){var r=new _glyph.Glyph({index:n,font:t});return r.path=function(){var n=e(t,r,h);return n.unitsPerEm=t.unitsPerEm,n},r}},module.exports=GlyphSet;
