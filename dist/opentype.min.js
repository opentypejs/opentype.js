...
"use strict";function derive(i,t,o,s,d){return Math.pow(1-d,3)*i+3*Math.pow(1-d,2)*d*t+3*(1-d)*Math.pow(d,2)*o+Math.pow(d,3)*s}function BoundingBox(){this.x1=Number.NaN,this.y1=Number.NaN,this.x2=Number.NaN,this.y2=Number.NaN}BoundingBox.prototype.isEmpty=function(){return isNaN(this.x1)||isNaN(this.y1)||isNaN(this.x2)||isNaN(this.y2)},BoundingBox.prototype.addPoint=function(i,t){"number"==typeof i&&((isNaN(this.x1)||isNaN(this.x2))&&(this.x1=i,this.x2=i),i<this.x1&&(this.x1=i),i>this.x2&&(this.x2=i)),"number"==typeof t&&((isNaN(this.y1)||isNaN(this.y2))&&(this.y1=t,this.y2=t),t<this.y1&&(this.y1=t),t>this.y2&&(this.y2=t))},BoundingBox.prototype.addX=function(i){this.addPoint(i,null)},BoundingBox.prototype.addY=function(i){this.addPoint(null,i)},BoundingBox.prototype.addBezier=function(i,t,o,s,d,n,a,h){var e=[i,t],r=[o,s],u=[d,n],N=[a,h];this.addPoint(i,t),this.addPoint(a,h);for(var x=0;1>=x;x++){var p=6*e[x]-12*r[x]+6*u[x],y=-3*e[x]+9*r[x]-9*u[x]+3*N[x],B=3*r[x]-3*e[x];if(0!==y){var v=Math.pow(p,2)-4*B*y;if(!(0>v)){var f=(-p+Math.sqrt(v))/(2*y);f>0&&1>f&&(0===x&&this.addX(derive(e[x],r[x],u[x],N[x],f)),1===x&&this.addY(derive(e[x],r[x],u[x],N[x],f)));var c=(-p-Math.sqrt(v))/(2*y);c>0&&1>c&&(0===x&&this.addX(derive(e[x],r[x],u[x],N[x],c)),1===x&&this.addY(derive(e[x],r[x],u[x],N[x],c)))}}else{if(0===p)continue;var g=-B/p;g>0&&1>g&&(0===x&&this.addX(derive(e[x],r[x],u[x],N[x],g)),1===x&&this.addY(derive(e[x],r[x],u[x],N[x],g)))}}},BoundingBox.prototype.addQuad=function(i,t,o,s,d,n){var a=i+2/3*(o-i),h=t+2/3*(s-t),e=a+1/3*(d-i),r=h+1/3*(n-t);this.addBezier(i,t,a,h,e,r,d,n)},exports.BoundingBox=BoundingBox;
...
"use strict";function parseGlyphCoordinate(e,r,t,o,n){var a;return(r&o)>0?(a=e.parseByte(),0===(r&n)&&(a=-a),a=t+a):a=(r&n)>0?t:t+e.parseShort(),a}function parseGlyph(e,r,t){var o=new parse.Parser(r,t);e.numberOfContours=o.parseShort(),e._xMin=o.parseShort(),e._yMin=o.parseShort(),e._xMax=o.parseShort(),e._yMax=o.parseShort();var n,a,s;if(e.numberOfContours>0){var i=e.endPointIndices=[];for(s=0;s<e.numberOfContours;s+=1)i.push(o.parseUShort());for(e.instructionLength=o.parseUShort(),e.instructions=[],s=0;s<e.instructionLength;s+=1)e.instructions.push(o.parseByte());var p=i[i.length-1]+1;for(n=[],s=0;p>s;s+=1)if(a=o.parseByte(),n.push(a),(8&a)>0)for(var h=o.parseByte(),l=0;h>l;l+=1)n.push(a),s+=1;if(check.argument(n.length===p,"Bad flags."),i.length>0){var u,c=[];if(p>0){for(s=0;p>s;s+=1)a=n[s],u={},u.onCurve=!!(1&a),u.lastPointOfContour=i.indexOf(s)>=0,c.push(u);var y=0;for(s=0;p>s;s+=1)a=n[s],u=c[s],u.x=parseGlyphCoordinate(o,a,y,2,16),y=u.x;var f=0;for(s=0;p>s;s+=1)a=n[s],u=c[s],u.y=parseGlyphCoordinate(o,a,f,4,32),f=u.y}e.points=c}else e.points=[]}else if(0===e.numberOfContours)e.points=[];else{e.isComposite=!0,e.points=[],e.components=[];for(var v=!0;v;){n=o.parseUShort();var x={glyphIndex:o.parseUShort(),xScale:1,scale01:0,scale10:0,yScale:1,dx:0,dy:0};(1&n)>0?(2&n)>0?(x.dx=o.parseShort(),x.dy=o.parseShort()):x.matchedPoints=[o.parseUShort(),o.parseUShort()]:(2&n)>0?(x.dx=o.parseChar(),x.dy=o.parseChar()):x.matchedPoints=[o.parseByte(),o.parseByte()],(8&n)>0?x.xScale=x.yScale=o.parseF2Dot14():(64&n)>0?(x.xScale=o.parseF2Dot14(),x.yScale=o.parseF2Dot14()):(128&n)>0&&(x.xScale=o.parseF2Dot14(),x.scale01=o.parseF2Dot14(),x.scale10=o.parseF2Dot14(),x.yScale=o.parseF2Dot14()),e.components.push(x),v=!!(32&n)}if(256&n)for(e.instructionLength=o.parseUShort(),e.instructions=[],s=0;s<e.instructionLength;s+=1)e.instructions.push(o.parseByte())}}function transformPoints(e,r){for(var t=[],o=0;o<e.length;o+=1){var n=e[o],a={x:r.xScale*n.x+r.scale01*n.y+r.dx,y:r.scale10*n.x+r.yScale*n.y+r.dy,onCurve:n.onCurve,lastPointOfContour:n.lastPointOfContour};t.push(a)}return t}function getContours(e){for(var r=[],t=[],o=0;o<e.length;o+=1){var n=e[o];t.push(n),n.lastPointOfContour&&(r.push(t),t=[])}return check.argument(0===t.length,"There are still points left in the current contour."),r}function getPath(e){var r=new path.Path;if(!e)return r;for(var t=getContours(e),o=0;o<t.length;o+=1){var n,a,s=t[o],i=s[0],p=s[s.length-1];i.onCurve?(n=null,a=!0):(i=p.onCurve?p:{x:(i.x+p.x)/2,y:(i.y+p.y)/2},n=i,a=!1),r.moveTo(i.x,i.y);for(var h=a?1:0;h<s.length;h+=1){var l=s[h],u=0===h?i:s[h-1];if(u.onCurve&&l.onCurve)r.lineTo(l.x,l.y);else if(u.onCurve&&!l.onCurve)n=l;else if(u.onCurve||l.onCurve){if(u.onCurve||!l.onCurve)throw new Error("Invalid state.");r.quadraticCurveTo(n.x,n.y,l.x,l.y),n=null}else{var c={x:(u.x+l.x)/2,y:(u.y+l.y)/2};r.quadraticCurveTo(u.x,u.y,c.x,c.y),n=l}}i!==p&&(n?r.quadraticCurveTo(n.x,n.y,i.x,i.y):r.lineTo(i.x,i.y))}return r.closePath(),r}function buildPath(e,r){if(r.isComposite)for(var t=0;t<r.components.length;t+=1){var o=r.components[t],n=e.get(o.glyphIndex);if(n.getPath(),n.points){var a;if(void 0===o.matchedPoints)a=transformPoints(n.points,o);else{if(o.matchedPoints[0]>r.points.length-1||o.matchedPoints[1]>n.points.length-1)throw Error("Matched points out of range in "+r.name);var s=r.points[o.matchedPoints[0]],i=n.points[o.matchedPoints[1]],p={xScale:o.xScale,scale01:o.scale01,scale10:o.scale10,yScale:o.yScale,dx:0,dy:0};i=transformPoints([i],p)[0],p.dx=s.x-i.x,p.dy=s.y-i.y,a=transformPoints(n.points,p)}r.points=r.points.concat(a)}}return getPath(r.points)}function parseGlyfTable(e,r,t,o){var n,a=new glyphset.GlyphSet(o);for(n=0;n<t.length-1;n+=1){var s=t[n],i=t[n+1];s!==i?a.push(n,glyphset.ttfGlyphLoader(o,n,parseGlyph,e,r+s,buildPath)):a.push(n,glyphset.glyphLoader(o,n))}return a}var check=require("../check"),glyphset=require("../glyphset"),parse=require("../parse"),path=require("../path");exports.getPath=getPath,exports.parse=parseGlyfTable;

},{"../check":3,"../glyphset":8,"../parse":12,"../path":13}],20:[function(require,module,exports){
"use strict";function parseTaggedListTable(r,e){for(var a=new parse.Parser(r,e),s=a.parseUShort(),t=[],o=0;s>o;o++)t[a.parseTag()]={offset:a.parseUShort()};return t}function parseCoverageTable(r,e){var a=new parse.Parser(r,e),s=a.parseUShort(),t=a.parseUShort();if(1===s)return a.parseUShortList(t);if(2===s){for(var o=[];t--;)for(var p=a.parseUShort(),n=a.parseUShort(),f=a.parseUShort(),i=p;n>=i;i++)o[f++]=i;return o}}function parseClassDefTable(r,e){var a=new parse.Parser(r,e),s=a.parseUShort();if(1===s){var t=a.parseUShort(),o=a.parseUShort(),p=a.parseUShortList(o);return function(r){return p[r-t]||0}}if(2===s){for(var n=a.parseUShort(),f=[],i=[],h=[],S=0;n>S;S++)f[S]=a.parseUShort(),i[S]=a.parseUShort(),h[S]=a.parseUShort();return function(r){for(var e=0,a=f.length-1;a>e;){var s=e+a+1>>1;r<f[s]?a=s-1:e=s}return f[e]<=r&&r<=i[e]?h[e]||0:0}}}function parsePairPosSubTable(r,e){var a,s,t=new parse.Parser(r,e),o=t.parseUShort(),p=t.parseUShort(),n=parseCoverageTable(r,e+p),f=t.parseUShort(),i=t.parseUShort();if(4===f&&0===i){var h={};if(1===o){for(var S=t.parseUShort(),u=[],v=t.parseOffset16List(S),U=0;S>U;U++){var l=v[U],g=h[l];if(!g){g={},t.relativeOffset=l;for(var T=t.parseUShort();T--;){var c=t.parseUShort();f&&(a=t.parseShort()),i&&(s=t.parseShort()),g[c]=a}}u[n[U]]=g}return function(r,e){var a=u[r];return a?a[e]:void 0}}if(2===o){for(var b=t.parseUShort(),P=t.parseUShort(),L=t.parseUShort(),k=t.parseUShort(),d=parseClassDefTable(r,e+b),w=parseClassDefTable(r,e+P),O=[],C=0;L>C;C++)for(var G=O[C]=[],K=0;k>K;K++)f&&(a=t.parseShort()),i&&(s=t.parseShort()),G[K]=a;var V={};for(C=0;C<n.length;C++)V[n[C]]=1;return function(r,e){if(V[r]){var a=d(r),s=w(e),t=O[a];return t?t[s]:void 0}}}}}function parseLookupTable(r,e){var a=new parse.Parser(r,e),s=a.parseUShort(),t=a.parseUShort(),o=16&t,p=a.parseUShort(),n=a.parseOffset16List(p),f={lookupType:s,lookupFlag:t,markFilteringSet:o?a.parseUShort():-1};if(2===s){for(var i=[],h=0;p>h;h++){var S=parsePairPosSubTable(r,e+n[h]);S&&i.push(S)}f.getKerningValue=function(r,e){for(var a=i.length;a--;){var s=i[a](r,e);if(void 0!==s)return s}return 0}}return f}function parseGposTable(r,e,a){var s=new parse.Parser(r,e),t=s.parseFixed();check.argument(1===t,"Unsupported GPOS table version."),parseTaggedListTable(r,e+s.parseUShort()),parseTaggedListTable(r,e+s.parseUShort());var o=s.parseUShort();s.relativeOffset=o;for(var p=s.parseUShort(),n=s.parseOffset16List(p),f=e+o,i=0;p>i;i++){var h=parseLookupTable(r,f+n[i]);2!==h.lookupType||a.getGposKerningValue||(a.getGposKerningValue=h.getKerningValue)}}var check=require("../check"),parse=require("../parse");exports.parse=parseGposTable;
...
"use strict";function parseWindowsKernTable(r){var e={};r.skip("uShort");var a=r.parseUShort();check.argument(0===a,"Unsupported kern sub-table version."),r.skip("uShort",2);var s=r.parseUShort();r.skip("uShort",3);for(var t=0;s>t;t+=1){var o=r.parseUShort(),p=r.parseUShort(),n=r.parseShort();e[o+","+p]=n}return e}function parseMacKernTable(r){var e={};r.skip("uShort");var a=r.parseULong();a>1&&console.warn("Only the first kern subtable is supported."),r.skip("uLong");var s=r.parseUShort(),t=255&s;if(r.skip("uShort"),0===t){var o=r.parseUShort();r.skip("uShort",3);for(var p=0;o>p;p+=1){var n=r.parseUShort(),u=r.parseUShort(),h=r.parseShort();e[n+","+u]=h}}return e}function parseKernTable(r,e){var a=new parse.Parser(r,e),s=a.parseUShort();if(0===s)return parseWindowsKernTable(a);if(1===s)return parseMacKernTable(a);throw new Error("Unsupported kern table version ("+s+").")}var check=require("../check"),parse=require("../parse");exports.parse=parseKernTable;
