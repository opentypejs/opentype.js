...
describe('parse.js', function() {
    ...
    describe('parseListOfLists', function() {
        ...
        it('can parse list of empty lists', function() {
            var p = new Parser(unhex('0001 0004 0000'), 0);
            assert.deepEqual(p.parseListOfLists(), [[]]);
        });
